...
public class ProviderServiceImpl extends AbstractService implements ProviderService {
    ...
    public void updateProvider(Provider newProvider) {
        ...
        if(newProvider.isDynamic()){
            ...
            cn.dubbo.govern.admin.model.Override override = generateDefaultOverride(newProvider);
            ...
            List<cn.dubbo.govern.admin.model.Override> overrides = overrideService.listByProvider(oldProvider);
            URL editOverrideUrl = override.toUrl();
            for(cn.dubbo.govern.admin.model.Override item:overrides){
    ...
    private cn.dubbo.govern.admin.model.Override generateDefaultOverride(Provider provider){
        Map<String,String> params = Tool.convertParametersMap(provider.getParameters());
        cn.dubbo.govern.admin.model.Override override = new cn.dubbo.govern.admin.model.Override();
