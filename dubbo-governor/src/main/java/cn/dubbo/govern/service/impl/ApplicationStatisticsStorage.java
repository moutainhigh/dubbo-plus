...
import cn.dubbo.govern.mapper.ApplicationMapper;
import cn.dubbo.govern.mapper.StatisticsMapper;
import cn.dubbo.govern.model.ApplicationInfo;
import cn.dubbo.govern.model.Statistics;
import cn.dubbo.govern.service.AbstractApplicationStatisticsStorage;
...
public class ApplicationStatisticsStorage  extends AbstractApplicationStatisticsStorage{
    ...
    public ApplicationStatisticsStorage(ApplicationMapper applicationMapper,StatisticsMapper statisticsMapper,MybatisSqlSessionFactoryBean mybatisSqlSessionFactoryBean,String application,int type){
        this(applicationMapper,statisticsMapper,mybatisSqlSessionFactoryBean,application,type,false);
    }

    public ApplicationStatisticsStorage(ApplicationMapper applicationMapper,StatisticsMapper statisticsMapper,MybatisSqlSessionFactoryBean mybatisSqlSessionFactoryBean,String application,int type,boolean needCreateTable){
        super(application);
    ...
    private boolean  createNewAppTable(final String applicationName) throws Exception {
    	Connection connection = mybatisSqlSessionFactoryBean.getObject().openSession().getConnection();
