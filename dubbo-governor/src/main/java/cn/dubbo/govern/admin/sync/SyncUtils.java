package cn.dubbo.govern.admin.sync;
...
public class SyncUtils {
    ...
    public static cn.dubbo.govern.admin.model.Override url2Override(Pair<Long, URL> pair) {
    	if (pair == null) {
    		return null;
    	}
        ...
        cn.dubbo.govern.admin.model.Override o = new cn.dubbo.govern.admin.model.Override();
        o.setId(id);
